...
sex1      = df1.set_index("pid")["resp_gend"].to_dict() # Enter code here!
caste1    = df1.set_index("pid")["caste"].to_dict() # Enter code here!
religion1 = df1.set_index("pid")["religion"].to_dict() # Enter code here!
...
def chance_homophily(chars):
    # Enter code here!
    """Computes chance of homophily in these networks"""
    chars_counts_dict = Counter(chars.values())
    chars_counts = np.array(list(chars_counts_dict.values()))
    chars_probs = chars_counts / sum(chars_counts)
    return sum(chars_probs**2)
